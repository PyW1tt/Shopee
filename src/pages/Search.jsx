          ...
          <section className="my-10">
            <div className="">
              {loading ? (
                ...
                <div className="mt-2 grid grid-cols-6 gap-5 max-lg:gap-2 max-lg:grid-cols-4 max-lg:px-2 max-md:grid-cols-3 max-md:gap-6 max-sm:grid-cols-2 max-sm:gap-1">
                  {product.map((item, index) => {
                    return (
                      <div
                        key={index}
                        className="  border border-gray-200 bg-white relative hover:border hover:border-[#ee4d2d] hover:-translate-y-1 w-[195px] hover:cursor-pointer max-sm:w-full"
                        onClick={() => {
